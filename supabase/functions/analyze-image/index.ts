...
const EDIT_PROMPT = `You are a forensic image analyst with one specific job: detect POST-PROCESSING MANIPULATION of originally captured photographs.\n\nCRITICAL DISTINCTION:\n- An image created entirely by an AI generator such as Midjourney, DALL-E, Stable Diffusion, Grok, or Firefly is NOT considered edited. Answer: edited=false\n- A real photograph that was later modified in Photoshop, GIMP, or any other editing tool IS considered edited. Answer: edited=true\n- A composite combining AI generation with real photo elements may be edited. Use your judgment.\n\nAnswer edited=true ONLY if you detect:\n- A real photograph with objects cloned, removed or inserted after capture\n- A real photograph with faces swapped or retouched\n- A real photograph with background replaced\n- Text, graphics or watermarks overlaid on a real photograph\n- Multiple real photographs spliced together\n\nAnswer edited=false if:\n- The image appears entirely AI-generated from scratch — this is creation not manipulation\n- The image appears to be an unmodified photograph\n- You cannot confidently determine manipulation occurred\n\nReturn ONLY valid JSON with no markdown:\n{"edited": true_or_false, "confidence": 50_to_99, "reasons": ["reason1", "reason2", "reason3"]}`;
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: `You are a forensic image analyst with one specific job: detect POST-PROCESSING MANIPULATION of originally captured photographs.\n\nCRITICAL DISTINCTION:\n- An image created entirely by an AI generator such as Midjourney, DALL-E, Stable Diffusion, Grok, or Firefly is NOT considered edited. Answer: edited=false\n- A real photograph that was later modified in Photoshop, GIMP, or any other editing tool IS considered edited. Answer: edited=true\n- A composite combining AI generation with real photo elements may be edited. Use your judgment.\n\nAnswer edited=true ONLY if you detect:\n- A real photograph with objects cloned, removed or inserted after capture\n- A real photograph with faces swapped or retouched\n- A real photograph with background replaced\n- Text, graphics or watermarks overlaid on a real photograph\n- Multiple real photographs spliced together\n\nAnswer edited=false if:\n- The image appears entirely AI-generated from scratch — this is creation not manipulation\n- The image appears to be an unmodified photograph\n- You cannot confidently determine manipulation occurred\n\nReturn ONLY valid JSON with no markdown:\n{"edited": true_or_false, "confidence": 50_to_99, "reasons": ["reason1", "reason2", "reason3"]}`,
              },
              {
                type: "image_url",
